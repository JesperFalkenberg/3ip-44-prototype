CREATE DATABASE IF NOT EXISTS despiteProducts;
USE despiteProducts;
-- YEET
-- DROP TABLE averages, products, stepValues, stepDescriptions;
-- CREATE
...
CREATE TABLE IF NOT EXISTS stepValues(
...
CREATE TABLE IF NOT EXISTS stepDescriptions(
    productId int NOT NULL,
    stepNum int NOT NULL,
...
-- POPULATE
INSERT INTO averages (productType, CO2, transport, water) VALUES ('tshirt', 4.07, 32000, 15000);
INSERT INTO products (name, productType) VALUES ('Kortærmet T-shirt | Black/Royal Blue','tshirt');
INSERT INTO
...
-- SELECT * FROM STEPVALUES;
-- SELECT * FROM STEPDESCRIPTIONS;